...
export class EmployeeRepository {
    ...
    private async triggerEvent(data: EmployeeEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices-Employees-Employee", ["trigger"]);
        ...
        producer.topic("codbex-invoices/Employees/Employee").send(JSON.stringify(data));
    }
}