...
export class CurrencyRepository {
    ...
    private async triggerEvent(data: CurrencyEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices/Currencies/Currency", ["trigger"]);
        ...
        producer.queue("codbex-invoices/Currencies/Currency").send(JSON.stringify(data));
    }
}