...
export class SupplierRepository {
    ...
    private async triggerEvent(data: SupplierEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices/Suppliers/Supplier", ["trigger"]);
        ...
        producer.queue("codbex-invoices/Suppliers/Supplier").send(JSON.stringify(data));
    }
}