...
export class CustomerRepository {
    ...
    private async triggerEvent(data: CustomerEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices/Customers/Customer", ["trigger"]);
        ...
        producer.queue("codbex-invoices/Customers/Customer").send(JSON.stringify(data));
    }
}