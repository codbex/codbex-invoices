...
export class ProductRepository {
    ...
    private async triggerEvent(data: ProductEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices/Products/Product", ["trigger"]);
        ...
        producer.queue("codbex-invoices/Products/Product").send(JSON.stringify(data));
    }
}