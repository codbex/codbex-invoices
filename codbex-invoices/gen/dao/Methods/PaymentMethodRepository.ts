...
export class PaymentMethodRepository {
    ...
    private async triggerEvent(data: PaymentMethodEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices-Methods-PaymentMethod", ["trigger"]);
        ...
        producer.topic("codbex-invoices/Methods/PaymentMethod").send(JSON.stringify(data));
    }
}