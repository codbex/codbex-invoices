...
export class SentMethodRepository {
    ...
    private async triggerEvent(data: SentMethodEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices-Methods-SentMethod", ["trigger"]);
        ...
        producer.topic("codbex-invoices/Methods/SentMethod").send(JSON.stringify(data));
    }
}