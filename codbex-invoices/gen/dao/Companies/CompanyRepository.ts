...
export class CompanyRepository {
    ...
    private async triggerEvent(data: CompanyEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices-Companies-Company", ["trigger"]);
        ...
        producer.topic("codbex-invoices/Companies/Company").send(JSON.stringify(data));
    }
}