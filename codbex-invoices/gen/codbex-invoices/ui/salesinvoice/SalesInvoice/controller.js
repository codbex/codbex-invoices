angular.module('page', ['blimpKit', 'platformView', 'EntityService'])
	...
	.controller('PageController', ($scope, $http, EntityService, Extensions, ButtonStates) => {
		...
		Dialogs.addMessageListener({ topic: 'codbex-invoices.salesinvoice.SalesInvoice.entitySearch', handler: () => {
			resetPagination();
		...
		$scope.loadPage = (pageNumber, filter) => {
			...
			EntityService.count(filter).then((resp) => {
				...
				EntityService.search(filter).then((response) => {
					...
					Dialogs.showAlert({
						title: 'SalesInvoice',
						message: `Unable to list/filter SalesInvoice: '${message}'`,
				...
				Dialogs.showAlert({
					title: 'SalesInvoice',
					message: `Unable to count SalesInvoice: '${message}'`,
					type: AlertTypes.Error
				});
				console.error('EntityService:', error);
			});
		...
		$scope.deleteEntity = () => {
			...
			Dialogs.showDialog({
				...
				message: `Are you sure you want to delete SalesInvoice? This action cannot be undone.`,
				buttons: [{
					id: 'delete-btn-yes',
				...
				if (buttonId === 'delete-btn-yes') {
					EntityService.delete(id).then(() => {
						...
						Dialogs.showAlert({
							title: 'SalesInvoice',
							message: `Unable to delete SalesInvoice: '${message}'`,
							type: AlertTypes.Error
						});
						console.error('EntityService:', error);
					});
