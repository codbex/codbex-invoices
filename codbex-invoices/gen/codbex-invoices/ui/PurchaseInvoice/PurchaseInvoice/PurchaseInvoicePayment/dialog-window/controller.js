angular.module('page', ['blimpKit', 'platformView', 'platformLocale', 'EntityService'])
	...
	.controller('PageController', ($scope, $http, ViewParameters, LocaleService, EntityService) => {
		...
		LocaleService.onInit(() => {
			...
			$scope.formHeaders.select = LocaleService.t('codbex-invoices:defaults.formHeadSelect', { name: '$t(codbex-invoices:t.PURCHASEINVOICEPAYMENT)' });
			$scope.formHeaders.create = LocaleService.t('codbex-invoices:defaults.formHeadCreate', { name: '$t(codbex-invoices:t.PURCHASEINVOICEPAYMENT)' });
			$scope.formHeaders.update = LocaleService.t('codbex-invoices:defaults.formHeadUpdate', { name: '$t(codbex-invoices:t.PURCHASEINVOICEPAYMENT)' });
			propertySuccessfullyCreated = LocaleService.t('codbex-invoices:messages.propertySuccessfullyCreated', { name: '$t(codbex-invoices:t.PURCHASEINVOICEPAYMENT)' });
			propertySuccessfullyUpdated = LocaleService.t('codbex-invoices:messages.propertySuccessfullyUpdated', { name: '$t(codbex-invoices:t.PURCHASEINVOICEPAYMENT)' });
		});
		...
		$scope.create = () => {
			...
			EntityService.create(entity).then((response) => {
				...
				Notifications.show({
					title: LocaleService.t('codbex-invoices:t.PURCHASEINVOICEPAYMENT'),
				...
				Dialogs.showAlert({
					title: LocaleService.t('codbex-invoices:t.PURCHASEINVOICEPAYMENT'),
					message: LocaleService.t('codbex-invoices:messages.error.unableToCreate', { name: '$t(codbex-invoices:t.PURCHASEINVOICEPAYMENT)', message: message }),
		...
		$scope.update = () => {
			...
			EntityService.update(id, entity).then((response) => {
				...
				Dialogs.showAlert({
					title: LocaleService.t('codbex-invoices:t.PURCHASEINVOICEPAYMENT'),
					message: LocaleService.t('codbex-invoices:messages.error.unableToUpdate', { name: '$t(codbex-invoices:t.PURCHASEINVOICEPAYMENT)', message: message }),
					type: AlertTypes.Error
				});
				console.error('EntityService:', error);
			});
