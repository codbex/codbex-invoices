angular.module('page', ["ideUI", "ideView", "entityApi"])
	.config(["messageHubProvider", function (messageHubProvider) {
		messageHubProvider.eventIdPrefix = 'codbex-invoices.settings.SalesInvoiceStatus';
	}])
	.config(["entityApiProvider", function (entityApiProvider) {
		entityApiProvider.baseUrl = "/services/ts/codbex-invoices/gen/codbex-invoices/api/settings/SalesInvoiceStatusService.ts";
	}])
	.controller('PageController', ['$scope', 'messageHub', 'entityApi', 'Extensions', function ($scope, messageHub, entityApi, Extensions) {
		...
		Extensions.get('dialogWindow', 'codbex-invoices-custom-action').then(function (response) {
			$scope.pageActions = response.filter(e => e.perspective === "settings" && e.view === "SalesInvoiceStatus" && (e.type === "page" || e.type === undefined));
			$scope.entityActions = response.filter(e => e.perspective === "settings" && e.view === "SalesInvoiceStatus" && e.type === "entity");
		});
		...
		$scope.deleteEntity = function (entity) {
			...
			messageHub.showDialogAsync(
				...
				`Are you sure you want to delete SalesInvoiceStatus? This action cannot be undone.`,
				[{
					id: "delete-btn-yes",
					type: "emphasized",
					label: "Yes",
