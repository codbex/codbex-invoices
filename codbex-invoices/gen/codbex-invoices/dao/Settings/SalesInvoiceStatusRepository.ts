...
export interface SalesInvoiceStatusEntityEvent {
...
export interface SalesInvoiceStatusUpdateEntityEvent extends SalesInvoiceStatusEntityEvent {
    readonly previousEntity: SalesInvoiceStatusEntity;
}
...
export class SalesInvoiceStatusRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(SalesInvoiceStatusRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: SalesInvoiceStatusEntityOptions = {}): SalesInvoiceStatusEntity | undefined {
    ...
    private async triggerEvent(data: SalesInvoiceStatusEntityEvent | SalesInvoiceStatusUpdateEntityEvent) {
