...
export interface SalesInvoiceTypeEntityEvent {
...
export interface SalesInvoiceTypeUpdateEntityEvent extends SalesInvoiceTypeEntityEvent {
...
export class SalesInvoiceTypeRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(SalesInvoiceTypeRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: SalesInvoiceTypeEntityOptions = {}): SalesInvoiceTypeEntity | undefined {
