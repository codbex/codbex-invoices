...
export class DebitNoteRepository {
    ...
    private async triggerEvent(data: DebitNoteEntityEvent | DebitNoteUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices-Note-DebitNote", ["trigger"]);
        ...
        producer.topic("codbex-invoices-Note-DebitNote").send(JSON.stringify(data));
    }
}
