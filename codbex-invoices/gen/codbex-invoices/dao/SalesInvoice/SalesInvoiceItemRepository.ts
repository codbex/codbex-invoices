...
export interface SalesInvoiceItemEntityEvent {
...
export interface SalesInvoiceItemUpdateEntityEvent extends SalesInvoiceItemEntityEvent {
    readonly previousEntity: SalesInvoiceItemEntity;
}
...
export class SalesInvoiceItemRepository {
    ...
    private static readonly DEFINITION = {
        ...
        properties: [
            ...
            {
                name: "VATRate",
                column: "SALESINVOICEITEM_VATRATE",
                type: "DECIMAL",
            },
            {
                name: "VAT",
    ...
    public findById(id: number, options: SalesInvoiceItemEntityOptions = {}): SalesInvoiceItemEntity | undefined {
    ...
    private async triggerEvent(data: SalesInvoiceItemEntityEvent | SalesInvoiceItemUpdateEntityEvent) {
