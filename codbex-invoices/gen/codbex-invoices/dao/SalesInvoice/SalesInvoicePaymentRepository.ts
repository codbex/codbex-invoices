...
export interface SalesInvoicePaymentEntityEvent {
...
export interface SalesInvoicePaymentUpdateEntityEvent extends SalesInvoicePaymentEntityEvent {
...
export class SalesInvoicePaymentRepository {
    ...
    public findById(id: number, options: SalesInvoicePaymentEntityOptions = {}): SalesInvoicePaymentEntity | undefined {
