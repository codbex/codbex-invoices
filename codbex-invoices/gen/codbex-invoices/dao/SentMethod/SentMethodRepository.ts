...
export class SentMethodRepository {
    ...
    private async triggerEvent(data: SentMethodEntityEvent | SentMethodUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-invoices-SentMethod-SentMethod", ["trigger"]);
        ...
        producer.topic("codbex-invoices-SentMethod-SentMethod").send(JSON.stringify(data));
    }
}
