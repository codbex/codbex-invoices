...
export class SalesInvoiceItemRepository extends Repository<SalesInvoiceItemEntity> {
    ...
    public override findById(id: string | number, options?: Options): SalesInvoiceItemEntity | undefined {
    ...
    public override findAll(options?: Options): SalesInvoiceItemEntity[] {
    ...
    public override update(entity: SalesInvoiceItemEntity): void {
        entity.Net = entity.Quantity * entity.Price;
        entity.VAT = Math.round((entity.Net * entity.VATRate / 100) * 100) / 100;
        entity.Gross = entity.Net + entity.VAT;
        super.update(entity);
