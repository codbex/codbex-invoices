...
const dao = require("codbex-invoices/gen/dao/entities/Currency");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-invoices/gen/api/Currency.js/" + entity.Code);
