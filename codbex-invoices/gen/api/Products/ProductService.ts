...
const validationModules = await Extensions.loadExtensionModules("codbex-invoices-Products-Product", ["validate"]);
...
class ProductService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-invoices/gen/api/Products/ProductService.ts/" + entity.Id);
