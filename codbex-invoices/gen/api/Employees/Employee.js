...
const dao = require("codbex-invoices/gen/dao/Employees/Employee");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-invoices/gen/api/Employee.js/" + entity.Id);
