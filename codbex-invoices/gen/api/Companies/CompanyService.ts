...
const validationModules = await Extensions.loadExtensionModules("codbex-invoices-Companies-Company", ["validate"]);
...
class CompanyService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-invoices/gen/api/Companies/CompanyService.ts/" + entity.Id);
