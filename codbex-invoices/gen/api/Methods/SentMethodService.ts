...
const validationModules = await Extensions.loadExtensionModules("codbex-invoices-Methods-SentMethod", ["validate"]);
...
class SentMethodService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-invoices/gen/api/Methods/SentMethodService.ts/" + entity.Id);
