...
const dao = require("codbex-invoices/gen/dao/PurchaseOrder/PurchaseOrder");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-invoices/gen/api/PurchaseOrder.js/" + entity.Id);
